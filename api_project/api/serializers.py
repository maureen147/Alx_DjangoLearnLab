...
class AuthorSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        """
        Custom representation to handle the nested book relationship.
        
        This method ensures that when serializing an Author instance, all related
        Book instances are included in the output using the BookSerializer.
        """
        representation = super().to_representation(instance)
        # The nested books are automatically handled by the BookSerializer field
